...
k = int(input("Введите количество строк (столбцов) квадратной матрицы в интервале от 1 до 100:"))
while k < 1 or k > 100:
    k = int(input("\nВы ввели неверное число"
                      "\nВведите количество строк (столбцов) квадратной матрицы в интервале от 1 до 100:"))

# Заполняем матрицу
Matrix = np.random.randint(10, size=(k, k))
print("Матрица:\n", Matrix)
